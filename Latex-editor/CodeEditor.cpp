...
[[maybe_unused]] bool CodeEditor::autoIndentation() const { return m_auto_indentation; }

[[maybe_unused]] void CodeEditor::setAutoParentheses(bool enabled) {
  m_auto_parentheses = enabled;
}

[[maybe_unused]] bool CodeEditor::isAutoParentheses() const { return m_auto_parentheses; }

[[maybe_unused]] void CodeEditor::setTabReplace(bool enabled) { m_replace_tab = enabled; }
