 ...
 */
class FramedText : public QObject, public QTextObjectInterface {
    Q_OBJECT
  ...
  public:
     ...
     */
    explicit FramedText(QObject *parent = nullptr);

    // Disable copying
    FramedText(const FramedText &) = delete;
    FramedText &operator=(const FramedText &) = delete;
