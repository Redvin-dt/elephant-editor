...
struct qt_meta_stringdata_LatexCompleter_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LatexCompleter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LatexCompleter_t qt_meta_stringdata_LatexCompleter = {
    {
QT_MOC_LITERAL(0, 0, 14) // "LatexCompleter"
...
QT_INIT_METAOBJECT const QMetaObject LatexCompleter::staticMetaObject = { {
    QMetaObject::SuperData::link<QCompleter::staticMetaObject>(),
    qt_meta_stringdata_LatexCompleter.data,
    qt_meta_data_LatexCompleter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LatexCompleter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LatexCompleter.stringdata0))
